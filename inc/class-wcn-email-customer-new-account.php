...
if ( ! class_exists( 'WCN_Email_Customer_New_Account', false ) ) :

	class WCN_Email_Customer_New_Account extends WC_Email {
		...
		public function __construct() {
			$this->id             = 'wcn_customer_new_account';
			...
			$this->template_html  = WCN_DIR . '/templates/emails/customer-new-account.php';
		...
		public function trigger( $user_id, $user_pass = '', $password_generated = false ) {
			...
			if ( $user_id ) {
				...
				$this->customer_number		= get_user_meta($user_id,'customer_number',true);
			}
...
return new WCN_Email_Customer_New_Account();
