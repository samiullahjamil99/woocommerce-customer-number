...
function wcn_show_customer_number_on_dashboard() {
	...
	<p style="font-size:1.2em">Um sich zu <strong>verifizieren</strong>, teilen Sie bitte lhre Kundennummer per Whatsapp an folgende Nummer mit: <a href="https://wa.me/4917624245365" target="_blank" style="margin-left:10px;display:inline-flex; transform: translateY(6px);align-items:center;"><svg style="pointer-events:none; height:25px; width:25px;margin-right:10px" width="50px" height="50px" viewBox="0 0 1024 1024">
    <defs>
